var bio = { "name": "James Ciclitra", "welcomeMessage": "Product Designer based in London, creating complex digital products that lead to better user experiences. I love to design beautifully simple interfaces, code, iterate and create. I am an experienced and capable Digital Product Designer with over two years’ professional experience. ", "contacts": [{ "email": "jciclitira@gmail.com", "website": "jciclitira.com" }], "skills": ["Sketching", "UI/UX Design", "Interaction Design", "Prototyping", "Wireframes", "Grid & Layout", "Color Theory", "Typography", "Design Research", "Visual Design"], };
...
var work = { "jobs": [{ "employer": "CrowdScores", "title": "Product Designer", "dates": "September 2015 - January 2017", "description": "CrowdScores is a real-time sports data application. I had the pleasure of working as the principal designer, taking responsibility for a variety of roles. Responsibilities included improving the existing product, researching and developing new features, conceptualising ideas and prototyping.", "url": "https://CrowdScores.com/" }, { "employer": "Suggestv", "title": "Product & Web Development", "location": "London - United Kingdom", "dates": "January 2017 - April 2017", "description": "Suggestv is the inventor of semantic video distribution. I was responsible for designing and facilitating the production of a semantic video distribution platform using React. ", "url": "https://www.sugges.tv/" }, { "employer": "Numilli", "title": "Freelance Designer", "dates": "January 2017 - Present", "description": "Numilli app - Bitcoin safe and easy. Numilli aims to makes it easy to securely buy and sell bitcoin currency on the go using a mobile app and ATM machine. My ongoing responsibility is the design and branding for the mobile app, web platform and ATM machines ", "url": "http://numilli.surge.sh/" }] };
var project = { "project": [{ "title": "Suggestv - Lead Generation Landing Pages", "dates": "", "description": "The aim of the Suggestv landing page is used to capture user data, such as a name and email address. The sole purpose of the site is to connect the in-house sales team with prospect clients. The site is build using a light weight tachyons framework", "images": ["images/suggestv-1.jpg", "images/suggestv-2.jpg", "images/suggestv-3.jpg"], "url": "https://www.sugges.tv/", "demo": "https://abundant-scissors.surge.sh/" }, { "title": "CrowdScores - components", "dates": "", "description": "Using structural elements from Google's Material Design Stickersheet & iOS 10 UI kit, the CrowdScores components sheet was creted containing various elements that makeup the majority layouts layouts within the app.", "images": ["images/nexus.jpg", "images/players.jpg", "images/samsung.jpg"], "url": "https://github.com/james-ciclitira/Stickersheets", "demo": "https://twitter.com/jimmy__design/status/802513442816933888" }] };
...
var development = { "development": [{ "title": "HTML", "image": ["images/html.svg"] }, { "title": "CSS", "image": ["images/css.svg"] }, { "title": "React", "image": ["images/react.svg"] }, { "title": "Javascript", "image": ["images/js.svg"] }] };
...
work.display = function() {
    if (work.jobs.length > 0) { $("#workExperience").append(HTMLworkStart);
...
education.display = function() { education.schools.forEach(function(school) { $("#education").append(HTMLschoolStart);
...
projects.display = function() { project.project.forEach(function(item) { $("#projects").append(HTMLprojectStart);
...
development.display = function() { development.development.forEach(function(tools) {
...
tools.display = function() { tools.tools.forEach(function(tools) {
