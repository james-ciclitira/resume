var bio = { "name": "James Ciclitira", "welcomeMessage": "Product and Industrial Designer based in Berlin, designing meaningful experiences using user-centred design practices with the end goal of understanding customers needs and designing products that creatively resolve their problems.", "contacts": [{ "email": "jciclitira@gmail.com", "website": "jciclitira.com" }], "skills": ["Sketching", "UX design", "Interface Design", "Prototyping", "Wireframes", "Grid & Layout", "Industrial Design", "Typography", "User Research", "3D CAD Software"], };
var education = { "schools": [{ "name": "The University of Edinburgh", "degree": "Industrial and Product Design", "majors": "2:1 BA (Hons)", "dates": "2011 - 2015", "url": "http://www.eca.ed.ac.uk/school-of-design/undergraduate/product-design-ba-hons" }, ] };
var work = {
  "jobs": [
    ...
    { "employer": "YunoJuno, Quidco, Numilli, Suggestv", "title": "Freelance Designer", "dates": "2016 - 2017", "description": "Duing this time contributed as a freelance consultant in the disciplines of research, design and web developmernt for companies such as YunoJuno, Quidco, Numilli, Suggestv.", "url": "#" },
