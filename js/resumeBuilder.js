var bio = { "name": "James Ciclitira", "welcomeMessage": "Digital Product Designer based in London specialising in web & native application. I am an experienced and capable designer with a passion for building experiences and creatively resolving problems.", "contacts": [{ "email": "jciclitira@gmail.com", "website": "jciclitira.com" }], "skills": ["Sketching", "UI/UX Design", "Interaction Design", "Prototyping", "Wireframes", "Grid & Layout", "Color Theory", "Typography", "Design Research", "Visual Design"], };
